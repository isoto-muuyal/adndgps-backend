...
public class SA200_5051 extends Thread
{ 
	    ...
	    try { 
	         ...
	         try { 
	              while (serverContinue)
	                 {
	                  System.out.println ("Waiting for Connection with GPS Models ST215 and ST330");
	                  new SA200_5051 (serverSocket.accept()); 
	                 }
	             } 
	         catch (IOException e) 
	             { 
	        ...
	        { 
	         System.err.println("Could not listen on port: 5051."); 
	         System.exit(1); 
	        } 
	    finally
	        {
	         try {
	             ...
	             { 
	              System.err.println("Could not close port: 5051."); 
	              System.exit(1); 
	             } 
	        }
	   }

	 private SA200_5051 (Socket clientSoc)
	   {
	    ...
	    try { 
	         ...
	         try {
		         ...
		         { 
		             ...
		             String sqlComandos = "Select * from j_interacciones_listener where condicion = 'false' and comando like 'SA200CMD;%' and contador > 0" ;
